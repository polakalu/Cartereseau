...
const config = {
    ...
    CSV: "https://docs.google.com/spreadsheets/d/e/2PACX-1vRdMT3JlGC-pWN72fi7ztFMEDgmHQdaoD0iZ7t_FH_wFD65Lr44fxWekzw6rhMrUBCqc4LKrw2L0GUc/pub?output=csv",
    ...
    TopBarInfo: ["Nom","Description","Contact","Site"],
    popupInfo: ["Nom"],
    filters: [
        {
            type: "checkbox",
