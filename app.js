...
function createPopup(currentFeature) {
    ...
    /** Text in the popup */
    const informations =`<h3>` + currentFeature.properties[config.popupNom] + `</h3>`+`<h4>`+ currentFeature.properties[config.popupDescrip] + `</h4>`+ `<h4>` + `<b>` + `Plus d'informations: ` + `</b>` + currentFeature.properties[config.popupDescrip] + `</h4>`;
        ...
        csv2geojson.csv2geojson(csvData, {
            ...
            map.addLayer({
                ...
                "paint": {
                    ...
                    "circle-color": "#DAA520", // color of circles
